  ...
  return (
    <SingleColumnLayout
      ...
      <div className='text-xl'>
        ...
        <p className='text-gray-800 dark:text-gray-300 mb-6'>Devtools is a free collection of 45+ carefully crafted tools useful for development. Stop pasting your code on various random websites, Devtools centralizes all your go-to utilities in one convenient location. Just select the tool you need on the left sidebar to get the task done quick.</p>
